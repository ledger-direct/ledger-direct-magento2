...
use Hardcastle\LedgerDirect\Model\PaymentMethod\Xrp;
use Magento\Payment\Model\InfoInterface;
use Magento\Sales\Model\Order;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;

class XrpTest extends TestCase
{
    /** @var Xrp|MockObject */
    private $method;
    ...
    protected function setUp(): void
    {
        ...
        $this->method = $this->getMockBuilder(Xrp::class)
    ...
    public function testCapabilitiesFlags()
    {
        ...
        $this->assertSame('xrp_payment', $this->method->getCode());
    }
